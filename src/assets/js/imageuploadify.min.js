...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-paperclip"></i><span class='imageuploadify-message'>Drag & Drop Your File(s) Here To Attachment</span><button type="button"class="btn btn-default">or select file to attachment</button></div></div>`);
            ...
            $(self).closest("form").on("submit", function(event) {
                ...
                xhr.onreadystatechange = function(e) {
                    if (xhr.IsStatus == 200 && xhr.readyState === XMLHttpRequest.DONE) {
