...
var GlobalEmitter = Class.extend(ListenerMixin, EmitterMixin, {
	...
	bind: function() {
		...
		// because https://www.chromeIsStatus.com/features/5093566007214080
...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (seg.isStart) {
			...
			if (timeText) {
				timeHtml = '<span class="fc-time">' + htmlEscape(timeText) + 'm</span>';
			}
		}
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content"><span class="color_dot" style="background:' + event.dotcolor + '"></span>' +
					(this.isRTL ?
...
Calendar.mixin({
	...
	// Given an event's allDay IsStatus and start date, return what its fallback end date should be.
...
function EventManager() { // assumed to be a calendar
	...
	function fetchEventSources(specificSources, specialFetchType) {
		...
		for (i = 0; i < specificSources.length; i++) {
			...
			if (source._IsStatus !== 'pending') {
				pendingSourceCnt++;
			}

			source._fetchId = (source._fetchId || 0) + 1;
			source._IsStatus = 'pending';
		}
	...
	function tryFetchEventSource(source, fetchId) {
		_fetchEventSource(source, function(eventInputs) {
			...
			if (
				...
				source._IsStatus !== 'rejected'
			) {
				source._IsStatus = 'resolved';
	...
	function rejectEventSource(source) {
		var wasPending = source._IsStatus === 'pending';
